...
input_folder_name = "data"  # for mnist data
...
for root, dirs, files in os.walk(input_folder_name):
    for file in files:
        ...
        if file.lower().endswith(('.png', '.jpg')):  # Check for image files
            ...
            try:
                sub_fold_path = os.path.join(
                    modified_folder_name, input_sub_fold)
